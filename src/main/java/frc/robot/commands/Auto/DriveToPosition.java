...
public class DriveToPosition extends CommandBase {
  ...
  public DriveToPosition(DriveSubsystem s_DriveSubsystem, double speed, double distanceInch) {
  ...
  public void execute() {
    ...
    System.out.println("INCHES: " + DriveSub.getRightMotorEncoderPosition());
