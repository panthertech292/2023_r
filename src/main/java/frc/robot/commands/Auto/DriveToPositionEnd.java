...
public class DriveToPositionEnd extends CommandBase {
  ...
  public DriveToPositionEnd(DriveSubsystem s_DriveSubsystem, double minSpeed, double distanceInch, double p) {
  ...
  public boolean isFinished() {
    return ((Math.abs(v_distanceInch - DriveSub.getRightMotorEncoderPosition())) < 1);
  }
}
