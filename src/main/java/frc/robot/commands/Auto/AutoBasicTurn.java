...
public class AutoBasicTurn extends SequentialCommandGroup {
  /** Creates a new BasicAuto. */
  public AutoBasicTurn(DriveSubsystem s_DriveSubsystem, ArmSubsystem s_ArmSubsystem, PickupSubsystem s_PickupSubsystem) {    
